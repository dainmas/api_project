...
$today = 'Today is ' . date("l") . ". What's your plan for today?";
$days = 365;
for ($d = 0; $d < $days; $d++) {
    $savaites_diena = date('N', strtotime("+$d days"));
    if ($savaites_diena < 4 && $savaites_diena == 5) {
        $text = 'Have a pleasant day!';
    } elseif ($savaites_diena == 4) {
        $text = "Today is Thursday's 10% sale";
    } elseif ($savaites_diena < 6) {
        $text = "Look for our Weekends offer!";
    }
}
...
<html>
    ...
    <body>
        ...
        <main>
            <section id="apie">
                <?php print "$today $text"; ?>
                <div class="container">
                    <div class="reklama">Large variety of vegetables</div>
