...
const endpoints = {
    get: 'api/vegetables/get.php',
    create: 'api/vegetables/create.php',
    update: 'api/vegetables/update.php',
    delete: 'api/vegetables/delete.php'
};
...
const table = {
    getElement: function () {
        return document.querySelector('#vegetable-table tbody');
    },
    init: function () {
        this.data.load();
